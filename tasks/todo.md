...
**Progress: T1–T14 done** (all tool domains) **+ T15 (npm packaging) + T18 (CI).** **Next: T16 Docker / T17 docs.** Checkpoints B & C (real on-prem call) still pending human verification.
